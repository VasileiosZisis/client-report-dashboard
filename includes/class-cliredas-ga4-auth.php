...
final class CLIREDAS_GA4_Auth
{
    ...
    public function handle_oauth_callback()
    {
        ...
        // State is generated by this plugin; reject unexpected formats early.
        ...
        delete_user_meta(get_current_user_id(), 'cliredas_ga4_oauth_state');
    ...
    {
        // Use an URL-safe random string (avoid base64 chars like "+" and "/" that can be mangled in redirects).
